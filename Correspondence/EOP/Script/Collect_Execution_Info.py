...
def collect_start_info(test_type):
  dict_info = {}
  dict_info.update({"summary":"EOP Regression Tests Execution - %s"%test_type})
...
#  folder = 'Failure\\%s' % Project.Variables.dict_test['testKey']
#
