...
def reset_bill_generate_status():
  Project.Variables.generate_indiv_risk_bills = False
...
def email_execution_results():
  ...
  EmailExecutionResults.email_execution_result(from_email, to_email, 'Correspondence-Individual Bills', exec_result, Project.Variables.client_id, Project.Variables.env,Project.Variables.start_time,test_report = Project.Variables.execution_results)